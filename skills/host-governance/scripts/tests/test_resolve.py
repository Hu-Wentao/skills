#!/usr/bin/env python3
"""Tests for the host-governance project configuration resolver."""
...
""",
    ...
    def test_generic_fallback_and_stable_id(self) -> None:
        first = self.run_resolver("--task", "control")
        second = self.run_resolver("--task", "control")
    ...
    def test_project_profile_is_composed(self) -> None:
        ...
        result = self.run_resolver("--task", "control", "--emit", "instructions")
    ...
    def test_invalid_schema_is_rejected(self) -> None:
        ...
        result = self.run_resolver("--task", "control")
        self.assertEqual(result.returncode, 2)
    ...
    def test_installed_global_skill_resolves_outside_project_skill_tree(self) -> None:
