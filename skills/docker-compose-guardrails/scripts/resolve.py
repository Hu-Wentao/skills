#!/usr/bin/env python3
"""Resolve generic and repository-owned instructions for docker-compose-guardrails."""
...
def main() -> int:
    ...
    parser.add_argument("--task", default="deploy")
